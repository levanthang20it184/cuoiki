							...
							<div class="panel panel-default">
								...
								<div id="sportswear_{{$category->id}}" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											@foreach($category->categoryChildren as $categoryChildren1)
											<li>
												<a href="{{route('category.product', ['slug'=>$categoryChildren1->slug,'id'=>$categoryChildren1->id])}}">{{$categoryChildren1->name}}
												</a>
											</li>
											@endforeach
										</ul>
