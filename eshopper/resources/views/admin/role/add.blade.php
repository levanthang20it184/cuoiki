      ...
      <div class="container-fluid">
        ...
        <form action="{{route('roles.store')}}"method="post" enctype="multipart/form-data" style="width:100%;">
            <div class="col-md-10">
              @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{old('name')}}" placeholder=" Nhập tên vai trò    " name="name">
            ...
            <div class="col-md-10">
                ...
                <div class="card text-white bg-info col-mb-3 dai">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                        <label for="">
                        <input type="checkbox" name="permission_id[]" class="checkbox_childrent" value="{{$permissionChildrentItem->id}}">
                    </label>        
